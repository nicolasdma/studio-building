...
export default function Model(props) {
  const { nodes, materials } = useGLTF("/building-unwraping-merged.glb");
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        material={nodes.Catenary001.material}
      ...
      <mesh
        ...
        position={[14.66, 14.885, -9.857]}
        rotation={[Math.PI / 2, 0, 0]}
        scale={[1.596, 1.596, 2.121]}
      />
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        material={nodes.Vert021.material}
      ...
      >
        ...
        <mesh
          ...
          material={nodes.Vert019.material}
...
useGLTF.preload("/building-unwraping-merged.glb");
